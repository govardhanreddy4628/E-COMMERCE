...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: BiCategory,
    subMenu: [
      { title: 'Manage Categories', icon: BiCategory, href: '/categories/manage' },
      { title: 'All Categories', icon: BiCategory, href: '/categories/all' },
      { title: 'Add Category', icon: BiCategory, href: '/categories/create' },
      { title: 'Add Subcategory', icon: BiCategory, href: '/categories/create-subcategory' },
      { title: 'Edit Category', icon: BiCategory, href: '/categories/edit' },
    ],
  },
  { title: 'Calendar', icon: FaRegCalendarAlt, href: '/calendar2' },
  { title: 'Chat', icon: IoChatboxOutline, href: '/chat' },
  { title: 'AI', icon: ImMagicWand, href: '/ai' },
  { title: 'Performance', icon: LineChart, href: '/underconstruction' },
  { title: 'Analysis', icon: PieChart, href: '/underconstruction' },
  { title: 'Markets', icon: VscGraph, href: '/underconstruction' },
